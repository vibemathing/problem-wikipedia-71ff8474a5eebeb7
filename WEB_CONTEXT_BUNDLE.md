...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-71ff8474a5eebeb7"
    ],
    "allowed_axioms": [
    ...
    "domain": {
      "description": "Draft source observation in Set theory; domain extraction is unresolved.",
      "objects": [
    ...
    "problem_id": "problem:wikipedia-71ff8474a5eebeb7",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-71ff8474a5eebeb7",
        "url": "https://en.wikipedia.org/wiki/Open_coloring_axiom"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Is OCA (the open coloring axiom ) consistent with $2^{\\aleph _{0}}>\\aleph _{2}$ ?",
      "version": 1
    },
    "title": "open coloring axiom",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "6f9418a6d5840311b49a1db0bc2766912acc47c81ab9b9cb1922a0f717bd531c"
}
```
